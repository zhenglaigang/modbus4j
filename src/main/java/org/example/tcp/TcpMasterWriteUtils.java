...
public class TcpMasterWriteUtils {

    static Log log = LogFactory.getLog(TcpMasterWriteUtils.class);
    ...
    public static ModbusMaster getMaster() throws ModbusInitException {
        ...
        ModbusMaster tcpMaster = ModbusUtil.modbusFactory.createTcpMaster(params, false);
        tcpMaster.init();
